...
public interface LoteFaseUmRepository extends BaseRespository<LoteFaseUm, UUID> {
    ...
    @Query("select l from LICITACAOFASE1 lic inner join lic.lote l where lic.uuid=:uuid and l.descricaoLote " +
            "like %:search% or l.descricaoLote is null  order by l.seq")
